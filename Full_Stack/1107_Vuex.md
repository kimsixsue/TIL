...
- beforeCreate, created, beforeMount, mounted, beforeUpdate, updated, beforeDestroy, destroyted
...
- 부모 컴포넌트의 mounted hook 이 실행 되었다고 해서 자식이 mount 된 것이 아니고,
...
- **actions 에는 보통 비동기 관련 작업이 진행 되지만 현재 별도의 비동기 관련 작업이 불필요하기 때문에 입력 받은 todoTitle 제목을 todoItem 객체로 만드는 과정을 Actions에서 작성할 예정**
...
>https://be-a-weapon.tistory.com/151
>
